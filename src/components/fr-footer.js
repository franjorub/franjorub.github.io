...
class FrFooter extends HTMLElement {
    connectedCallback() {
        ...
        this.innerHTML = `
      <footer class="mt-24 pt-8 border-t border-terminal-dim flex flex-col md:flex-row justify-between items-center text-[10px] opacity-40 uppercase tracking-widest gap-4">

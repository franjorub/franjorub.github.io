        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div class="space-y-4">
            ...
            <div class="pt-4 grid grid-cols-1 sm:grid-cols-3 gap-2">
              <div class="border border-terminal-dim p-2">
                <div class="text-xs opacity-50">EXP_YRS</div>
                <div class="text-xl">8+</div>
              </div>
              <div class="border border-terminal-dim p-2">
                <div class="text-xs opacity-50">PROJECTS</div>
                <div class="text-xl">20+</div>
              </div>
              <div class="border border-terminal-dim p-2">
                <div class="text-xs opacity-50">COMMIT</div>
                <div class="text-xl">100%</div>
              </div>
            </div>
          </div>
          <div class="border border-terminal-dim p-4 flex items-center justify-center bg-black">
            <pre class="text-[10px] md:text-xs text-terminal-dim leading-none"> ______   _____  
|  ____| |  __ \\ 
| |__    | |__) |
|  __|   |  _  / 
| |      | | \\ \\ 
